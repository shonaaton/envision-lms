...
export default function PageLoadingOverlay({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-white/72 backdrop-blur-sm">
      <div className="flex min-w-[240px] max-w-[90vw] items-center gap-4 rounded-3xl border border-brand/15 bg-white px-5 py-4 shadow-2xl shadow-brand/15">
        <div className="relative grid h-12 w-12 place-items-center rounded-2xl bg-brand text-white shadow-lg shadow-brand/25">
