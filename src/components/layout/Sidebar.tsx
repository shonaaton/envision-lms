...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/coach-pay", label: "My Earnings", icon: BadgeIndianRupee, featureKey: "coachPay", permission: "view_own", roles: ["instructor"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/coach-pay", label: "Coach Pay", icon: BadgeIndianRupee, featureKey: "coachPay" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/sales/performance", label: "Sales Performance", icon: TrendingUp, featureKey: "salesPerformance", roles: ["admin", "sub-admin"] },
      { href: "/admin/crm", label: "CRM Sync", icon: Repeat, featureKey: "crmAdmin", roles: ["admin", "sub-admin"] },
    ],
  },
  {
    id: "demo-center",
