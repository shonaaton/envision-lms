  ...
  if (demo?.isDemo && !demo.allowed) {
    return (
      <div className="rounded-3xl border border-amber-200 bg-white p-8 text-center shadow-xl">
        ...
        <p className="mx-auto mt-2 max-w-xl text-slate-600">You have used your demo Play vs Computer attempts. Please book a demo class so the academy team can guide you further.</p>
