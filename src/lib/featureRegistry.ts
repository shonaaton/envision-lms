...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  ...
  },
  {
    ...
    // academy-wide wage bill, so widening one permission can never hand a coach
    // everybody's pay.
    permissions: [
      view,
      { id: "view_all", label: "View All Coaches' Pay", critical: true },
    ...
    defaultRolePermissions: {
      instructor: ["view"],
      admin: ["view", "view_all", "manage_rates", "rule", "export"],
      ...
      "sub-admin": ["view", "view_all", "export"],
    },
  },
  {
    key: "notifications",
  ...
  },
  {
    ...
    label: "Tasks",
    category: "Communication",
    description: "Staff task manager: tasks raised automatically by app events plus tasks assigned between admins, sub-admins and sales, with daily reminders.",
    routes: ["/tasks"],
  ...
  },
  {
    ...
    category: "Communication",
    description: "Monthly progress reports: coaches rate each student on level-specific skills, admins approve, and the report is emailed to the family.",
    routes: ["/feedback"],
    apiPrefixes: ["/api/feedback"],
    permissions: [view, edit, approve],
    defaultStatus: "enabled",
    defaultRolePermissions: { student: ["view"], instructor: ["view", "edit"], admin: all(view, edit, approve), "sub-admin": ["view", "approve"] },
  },
  {
    key: "whatsapp",
    label: "WhatsApp",
  ...
  },
  {
    ...
    label: "Onboarding",
    category: "Administration",
    description: "Coach applications and onboarding decisions.",
    routes: ["/admin/onboarding", "/admin/coach-applications"],
