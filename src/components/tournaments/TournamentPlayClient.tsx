          ...
          {!activeGame ? (
            ...
            <>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 sm:mt-4">
                <button onClick={() => submitResult("resign")} className="inline-flex h-9 items-center gap-2 rounded-xl border border-red-200 bg-red-50 px-3 text-xs font-semibold text-red-700 sm:h-10 sm:px-4 sm:text-sm">
                  <Flag size={15} /> Resign
                </button>
                <button onClick={() => submitResult("draw")} className="inline-flex h-9 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-700 sm:h-10 sm:px-4 sm:text-sm">
